...
while True:
    ...
    schedul.add_job(Global, 'cron', hour= 17, minute=20)
    schedul.add_job(Global, 'cron', hour=17, minute=40)
    schedul.add_job(Global, 'cron', hour=18, minute=1)
    schedul.add_job(Global, 'cron', hour=18, minute=20)
    schedul.start()
